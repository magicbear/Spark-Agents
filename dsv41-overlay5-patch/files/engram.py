...
class Engram(nn.Module):
    ...
    def __init__(
        ...
        # Under the V2 runner, disk rows are staged by EngramDiskStager before
        # the forward so FULL and breakable graphs contain no host round trip.
        ...
        # shared by DP replicas stages every replica's tokens at once. Zeroing
        # also keeps graph-padding rows finite when disk prestaging is active.
